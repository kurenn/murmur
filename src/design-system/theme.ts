...
export const MM_THEMES: { light: VarMap; dark: VarMap } = {
  light: {
    "--bg": "oklch(0.978 0.0025 75)",
    "--surface": "oklch(0.999 0.001 75)",
    "--surface-2": "oklch(0.972 0.003 75)",
    "--surface-3": "oklch(0.952 0.004 75)",
    "--ink": "oklch(0.245 0.008 70)",
    "--ink-soft": "oklch(0.47 0.008 70)",
    "--ink-faint": "oklch(0.64 0.006 70)",
    "--line": "oklch(0.915 0.003 75)",
    "--line-soft": "oklch(0.94 0.0025 75)",
